...
difference() {
    ...
    hull() {
        translate([-(_width - _radius*2) / 2, -(_depth - _radius*2) / 2, _posz])
        cylinder(h=_height, r=_radius, center=true);
    ...
    hull() {
        color("red")
        translate([20, -(_depth - _radius*2) / 2 - 4, _posz])
        cylinder(h=_height, r=20, center=true);
