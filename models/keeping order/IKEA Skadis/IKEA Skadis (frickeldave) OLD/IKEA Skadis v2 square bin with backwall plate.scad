    ...
    difference() {
        difference() {
            union() {
                ...
                translate([-_radius, -_radius -10, 0])
                roundedcube(size = [_radius * 2, _radius * 2, _height], center = false, radius = 5, apply_to = "z");
                
            }

            translate([-_radius + _thickness, -_radius -10 + _thickness, _thickness])
            roundedcube(size = [_radius * 2 - _thickness * 2, _radius * 2 - _thickness * 2, _height], center = false, radius = 5, apply_to = "z");
